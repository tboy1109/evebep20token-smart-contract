...
abstract contract BEP20 is IBEP20 {
  ...
  bytes32 constant private BEP20TOKEN_ERC1820_INTERFACE_ID = keccak256( "BEP20Token" );
...
contract EveBEP20Token is BEP20Permit, VaultOwned {

    using SafeMath for uint256;

    constructor() BEP20("Trusterras Smart Token", "TST", 18) {
    }
